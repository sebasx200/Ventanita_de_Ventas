...
class VentanaAdicionarProducto(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Añadir información de producto")
        ...
        self.botonIngresar.clicked.connect(self.accion_BotonIngresarProducto)
        self.botonCancelar.clicked.connect(self.accion_BotonCancelarP)

        self.exec_()

    def accion_BotonIngresarProducto(self):

        self.datosCorrectos = True

        if (self.nombreProducto.text() == ''):
        ...
        if self.datosCorrectos:
            ...
            if self.datosCorrectos:
                ...
                self.file = open('BaseDeDatos/productos.txt', 'ab')
    ...
    def accion_BotonCancelarP(self):
        self.reject()
