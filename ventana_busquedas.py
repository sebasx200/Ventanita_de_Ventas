...
class Ventana_Busquedas(QMainWindow):

    def __init__(self, anterior):
        super(Ventana_Busquedas, self).__init__(anterior)

        self.ventanaAnterior = anterior

        self.setWindowTitle("Ventanita De Ventas: Búsquedas")
        ...
        self.letrero1.setText("Búsquedas")
        ...
        self.letrero2.setText(
            "Para buscar utilice el siguiente campo de texto")
